...
% Bakgrund
Olika mätinstrument är i dag monterade i nästan alla fordon för att bland annat
köra på rätt växel, optimera motorns styrprogram och operera olika
bromsfunktioner.
Vilken lutning fordonet framförs i kan vara avgörande för olika funktioner och
för det ändamålet mätes fordonets lutning med hjälp av en lutningsgivare.
...
Volvo ska utreda möjligheten att använda en ny lutningsgivare i bland annat en
helt elektrisk buss, därför behövs en algoritm för att felkompensera dessa
störningar tas fram.
