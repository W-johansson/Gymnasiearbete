...
\textit{Narxnet} (nonlinear autoregressive neural network with external input)
...
tidsserien.
Narxnät lämpar sig följdaktligen till att felkompensera lutningsgivare;
...
%inga fler modeline error i vim
%inga fler modeline error i vim
\end{itemize}
