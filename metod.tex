...
En buss kördes med en lutningsgivare och
en GPS som mätte hastigheten och altituden i bakre ändan.
...
Sju stycken loggar om \SI{30}{\second} var sparades från bussens styrenhet
med rådatan från lutningsgivaren, $\phi$, och bussens hastigheten som funktioner av tiden.
...
Flera neuronnät tränades i MATLAB med algoritmen stochastic gradient descent,
med $\phi$ och $a$ som inputs och $y$ som mål.
Neuronnät med ett dolt lager initierades med olika slumpade vikter och biases och
antalet neuroner, $ \{ 1, 2, 3, 4, 5 \} $; \emph{feedback delays}, $ \{ 1, 2, 3, 4, 5 \} $;
inlärningshastigheten, $\eta$, $ \{ 0.3, 0.5, 0.7 \} $; och minibatchens kardinalitet, $ \{ 1, 10, 20 \} $,
varierades för att hitta den bästa konfigurationen.
