...
För att hitta den den bästa möjliga konfigurationen för lutningskorrigering så tränades olika cascade- och feedforward  %Såg att det fanns ingen bakgrund om cascadeforward - Ska vi bara testa feedforward nätverk? 
