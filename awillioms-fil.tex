...
kan överkompensera.
Det kan därmed inte avgöra som är normaltillståndet och kommer alltid att säga
att fordonet befinner sig i en lutning även om det framförs på plan mark.
