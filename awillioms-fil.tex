...
\long\def\forfattare{
%{\Large\itshape William Johansson}\par
%\vspace{0.4cm}
%%{\large Medförfattare: {\itshape Forsman, A., Källberg, A. \& Lauri J.}\par
%\vspace{0.4cm}
\begin{tabular}{l r}
	{\large Författare:} 	& {\large\it Johansson, W.}\\
	{\large Medförfattare:} & {\large\it Forsman, A.}\\
							& {\large\it Källberg, A.}\\
							& {\large\it Lauri J.}\\
	{\large Handledare:}	& {\large\it Èva Fülöp}
\end{tabular}\par
}
