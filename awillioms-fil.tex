...
motoreffekt som aktiveras när lutningen är över \SI{2}{\percent} inte aktiveras
av låt säga en grop.
Därmed kommer den i praktiken aktiveras när den felkompenserade lutningen från
lutningsgivaren överstiger \SI{2}{\percent}.
...
% Felkällor
Varje neuronnätskonfiguration testas en gång med slumpade begynnelse variabler
