...
every neuron has an activation function---the sigmoid
function---and an overall training algorithm---stochastic gradient descent.
With variables as weights, biases, numbers of neurons in the hidden
...
Ytterligare en faktor är när nätet tränas på en begränsad datamängd är att det
kan överanpassa.
Det kan därmed inte avgöra som är ett ``normaltillstånd'' och kommer alltid att
...
den utsätts för noga kan övervakas. Det skulle krävas betydligt mycket mer tid
